...
for layers in lbc_layers:
    for size in data_sizes:
        for lr in learning_rate:
            model_file = 'model_' + str(lr) + '_' + str(size) + '_' + str(layers) + '_' + str(epochs) + '_dr03_3_class.pt'
            output_file = 'file_' + str(lr) + '_' + str(size) + '_' + str(layers) + '_' + str(epochs) + '_dr03_3_class.txt'
